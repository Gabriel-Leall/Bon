...
const accentOptions: { value: Accent; swatchClassName: string }[] = [
...
export type AdaptiveMode = 'full' | 'reduced' | 'off'
    ...
    <SettingsSection title={t('preferences.appearance')}>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        >
          <Select
            value={adaptiveMode}
            onValueChange={value => onAdaptiveModeChange(value as AdaptiveMode)}
