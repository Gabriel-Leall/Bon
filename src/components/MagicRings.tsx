...
export default function MagicRings({
  ...
  useEffect(() => {
    ...
    const animate = (t: number) => {
      ...
      const [smoothMouseX, smoothMouseY] = smoothMouseRef.current
      const nextSmoothMouseX = smoothMouseX + (mouseX - smoothMouseX) * 0.08
      const nextSmoothMouseY = smoothMouseY + (mouseY - smoothMouseY) * 0.08
      smoothMouseRef.current = [nextSmoothMouseX, nextSmoothMouseY]
      ...
      uniforms.uMouse.value.set(nextSmoothMouseX, nextSmoothMouseY)
